...
*   **Key Takeaway:** Do *not* use Chain-of-Thought (CoT) for function calling; it adds noise. Use CoT only for math/logic.
...
3.  **Stage 2: Execution (Mode Dependent)**
    ...
    *   **If Tool:**
        ...
        *   **B. Scaffold (Python):** Python looks up schema and builds template: `{"location": "<MASK>", "unit": "<MASK>"}`.

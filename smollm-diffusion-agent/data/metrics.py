...
def calculate_null_token_metrics(
    ...
    null_precision = (
                                 pred_is_null & label_is_null).float().sum() / pred_is_null.float().sum() if pred_is_null.any() else 0.0

    # Recall: of actual NULLs, how many are predicted
    null_recall = (
                              pred_is_null & label_is_null).float().sum() / label_is_null.float().sum() if label_is_null.any() else 0.0
